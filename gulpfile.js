...
const fontsConnectToStyleTask = async (params) => {
...
const watchTasksSet = parallel(browserSyncTask, watchersTask)
const defaultTasksSet = series(buildTasksSet, watchTasksSet)
